...
class Generate_model:
    def __init__(self,data,input_features,output,test_size,problem,n_steps_in,n_steps_out,dType,categorical_features,normalize_method=preprocessing.MinMaxScaler()):
    ...
    def build_model(self,model,epochs=10):
        ...
        model.fit(np.float32(x_train), np.float32(y_train),epochs=epochs,validation_data=(x_test,y_test))
